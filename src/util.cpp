...
int nAnonymizeGREXITAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\GREXIT
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\GREXIT
    // Mac: ~/Library/Application Support/GREXIT
    // Unix: ~/.GREXIT
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GREXIT";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "GREXIT.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "GREXITd.pid"));

...
Value smsgoptions(const Array& params, bool fHelp)
{
    ...
    if (mode == "list")
    {
        result.push_back(Pair("GREXIT", std::string("newAddressRecv = ") + (smsgOptions.fNewAddressRecv ? "true" : "false")));
        result.push_back(Pair("GREXIT", std::string("newAddressAnon = ") + (smsgOptions.fNewAddressAnon ? "true" : "false")));
    ...
    if (mode == "set")
    {
        ...
        if (optname == "newAddressRecv")
        {
            ...
            result.push_back(Pair("set GREXIT", std::string("newAddressRecv = ") + (smsgOptions.fNewAddressRecv ? "true" : "false")));
        } else
        if (optname == "newAddressAnon")
        {
            ...
            result.push_back(Pair("set GREXIT", std::string("newAddressAnon = ") + (smsgOptions.fNewAddressAnon ? "true" : "false")));
        } else
        {
    ...
    } else
    {
        ...
        result.push_back(Pair("expected", "smsgGREXIT [list|set <optname> <value>]"));
    };
    return result;
}

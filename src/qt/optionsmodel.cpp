...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeGREXITAmount"))
        settings.setValue("nAnonymizeGREXITAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeGREXITAmount = settings.value("nAnonymizeGREXITAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeGREXITAmount"))
        SoftSetArg("-anonymizeGREXITamount", settings.value("nAnonymizeGREXITAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeGREXITAmount:
            nAnonymizeGREXITAmount = value.toInt();
            settings.setValue("nAnonymizeGREXITAmount", nAnonymizeGREXITAmount);
            emit anonymizeGREXITAmountChanged(nAnonymizeGREXITAmount);
            break;
        default:
            break;
        }

...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. GREXIT can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("GREXIT");
    //XXX app.setOrganizationDomain("");
    if(GetBoolArg("-testnet", false)) // Separate UI settings for testnet
        app.setApplicationName("GREXIT-QT-testnet");
    else
        app.setApplicationName("GREXIT-QT");
    ...
    try
    {
		...
		window.setMessageModel(&messageModel);
                ...
                // If -min GREXIT passed, start window minimized.
